    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">GARDENEA</a>
        ...
        <header class="bg-dark py-5" >
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">WELCOME <?php echo $_GET['username_in'];?></br> IN GARDENEA</h1>
                    <p class="lead fw-normal text-white-50 mb-0">bloom where you planted</p>
                </div>
            </div>
        </header>
        <!-- Section-->
